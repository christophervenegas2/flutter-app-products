              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    ...
                    IconButton(icon: Icon(Icons.delete, color: Colors.red), onPressed: () => _deleteProduct(context, items[position],position)),
                    IconButton(icon: Icon(Icons.edit, color: Colors.blue), onPressed: () => _navigateToProduct(context, items[position])),
                    ]
                )
              ]
            );
